...
var IdTokenStrategy = require('./IdTokenStrategy');
...
module.exports = function (opts) {
    ...
    router.options(config.authorizationEndpoint, cors());
    ...
    // Token Endpoint
    router.options(config.tokenEndpoint, cors());
    ...
    // UserInfo Endpoint
    router.options(config.userInfoEndpoint, cors());
    ...
    // TokenInfo Endpoint
    router.options(config.tokenInfoEndpoint, cors());
    ...
    // Discovery Document
    router.options('/.well-known/openid-configuration', cors());
    ...
    // JSON Web Key Set
    router.options(config.jwksUri, cors());
